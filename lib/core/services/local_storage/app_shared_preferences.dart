...
import 'package:procuts_task/core/utils/constants.dart';
...
abstract class _AppSharedPreferencesKeys {
  ...
  static const filterId = 'filterId';
}
...
abstract class AppSharedPreferences {
  ...
  Future<bool> saveFilterId(String filterId);
  Future<bool> removeFilterId();
...
//endregion
  ...
  @override
  String getFilterId() {
    String? filterId = instance.getString(_AppSharedPreferencesKeys.filterId);
    return filterId ?? '';
  }

  @override
  Future<bool> saveFilterId(String filterId) =>
      instance.setString(_AppSharedPreferencesKeys.filterId, filterId);

  @override
  Future<bool> removeFilterId() =>
      instance.remove(_AppSharedPreferencesKeys.filterId);
}
