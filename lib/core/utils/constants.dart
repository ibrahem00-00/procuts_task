...
abstract class Constants {
  ...
  //   }
  // }
  static Future<String> convertFromFileToBase64(File image) async {
    var imageBytes = image.readAsBytesSync();
    log("--- convertFromFileToBase64 --");
    log("imageBytes length: ${imageBytes.length}");
    var compressImg = await getComporessList(imageBytes);

    String base64Image = base64Encode(compressImg);
    return base64Image;
  }

  static Future<Uint8List> getComporessList(Uint8List list) async {
