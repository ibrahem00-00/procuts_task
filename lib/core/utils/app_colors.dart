...
class MyColors {
  ...
  static const Color main = Color(0xff425486);
  static const Color secondaryColor = Color(0xffD4DCF1);

  static const Color secondColor = Color(0xffEF9E52);

  static const Color textColor = Colors.black;
  static const Color lightTextColor = Color(0xffB4B4B4);
...
// shared
  static Color borderColor = const Color(0xffEEEDEF);
...
class AppColors extends ThemeExtension<AppColors> {
  ...
  final Color backGroundFormFieldColor;
  ...
  const AppColors({
    ...
    required this.black,
    required this.white,
    required this.backGroundFormFieldColor,
  ...
  AppColors copyWith({
    ...
    Color? black,
    Color? white,
    Color? backGroundFormFieldColor,
    Color? secondColor,
    ...
    return AppColors(
      ...
      backGroundFormFieldColor:
          backGroundFormFieldColor ?? this.backGroundFormFieldColor,
  ...
  AppColors lerp(ThemeExtension<AppColors> other, double t) {
    ...
    final appColors = AppColors(
      ...
      backGroundFormFieldColor: Color.lerp(
              backGroundFormFieldColor, other.backGroundFormFieldColor, t) ??
          backGroundFormFieldColor,
